...
(function () {
    ...
    async function getOAuthToken() {
        ...
        return "YOUR_ACCESS_TOKEN"; // Replace with secure token retrieval
    }

    console.log("pbjs bid optimisation script with configurable settings and UPR updates active.");
})();
